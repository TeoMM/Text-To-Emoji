...
```sh
npx create-react-app Text-To-Emoji --template electron-node-react-sass-typescript

# or

yarn create react-app Text-To-Emoji --template electron-node-react-sass-typescript
```
